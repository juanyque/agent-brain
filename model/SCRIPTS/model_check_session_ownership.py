...
EXPECTED_ROWS: Final = tuple(
    ...
    for row in (
        ...
        (SESSION_RULES, "brain-internal-moves", "user", "standing-preauthorization"),
        (SESSION_RULES, "other-git-operations", "user", "explicit-authorization-required"),
        ...
        (JOBS, "brain-internal-moves", "user", "standing-preauthorization"),
        (JOBS, "other-git-operations", "user", "explicit-authorization-required"),
